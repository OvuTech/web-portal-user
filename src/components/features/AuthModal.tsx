      ...
      <div className="relative flex w-full max-w-[1200px] overflow-hidden rounded-[20px] bg-white shadow-2xl">
        ...
        <div className="flex w-full flex-col justify-center px-8 py-12 lg:w-1/2 lg:px-20 lg:py-16">
          <div className="mx-auto w-full max-w-md">
            <h1 className="mb-3 text-center text-3xl font-bold text-gray-900 lg:text-4xl">
            ...
            <p className="text-center text-xs text-gray-500 lg:text-sm">
              By signing in or registering, I confirm that i have read and agreed to OVU's{' '}
              <a href="/terms" className="font-semibold text-ovu-primary hover:underline">
                Terms & conditions
              </a>{' '}
              and{' '}
              <a href="/policy" className="font-semibold text-ovu-primary hover:underline">
                Policy
              </a>
            </p>
          </div>
